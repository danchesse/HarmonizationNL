scenario = "Auditory Oddball Instructions (Dutch Version)";
...
wavefile { filename = "AODinstruct1NL.wav"; } adi1;
sound {
    wavefile adi1;
    attenuation = 0.2;
} aod1Instruction;
...
wavefile { filename = "AODinstruct3NL.wav"; } adi3;
sound {
    wavefile adi3;
    attenuation = 0.2;
} aod3Instruction;

wavefile { filename = "AODinstruct4NL.wav"; } adi4;
sound {
    wavefile adi4;
    attenuation = 0.2;
} aod4Instruction;

wavefile { filename = "AODinstruct5NL.wav"; } adi5;
sound {
    wavefile adi5;
    attenuation = 0.2;
} aod5Instruction;
